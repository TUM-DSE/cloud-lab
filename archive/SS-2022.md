...
|----------------------------------------------------------------------------|------------------------------------------|---------------|
| [Kick-off meeting](docs/SS-22/kick-off.pdf)                                | TBA                                      | N/A           |
| [Task #0: Containers and job deployment](docs/SS-22/task-0-containers.pdf) | TBA                                      | 2 weeks       |
| [Task #1: Single-node KVS](docs/SS-22/task-1-rocksDB.pdf)                  | TBA                                      | 3 weeks       |
| [Task #2: Distributed KVS](docs/SS-22/task-2-sharding.pdf)                 | TBA                                      | 3 weeks       |
| [Task #3: Fault-tolerant KVS](docs/SS-22/task-3-replication.pdf)           | TBA                                      | 3 weeks       |
